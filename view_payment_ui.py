...
# Form implementation generated from reading ui file 'view_payment.ui'
#
...
"")
        ...
        self.paymentTable = QtWidgets.QTableWidget(Dialog)
        self.paymentTable.setGeometry(QtCore.QRect(210, 100, 991, 441))
        self.paymentTable.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.paymentTable.setStyleSheet("background-color: rgba(255, 255, 255,.9);\n"
"\n"
"font:  12pt \"Segoe UI \";")
        self.paymentTable.setObjectName("paymentTable")
        self.paymentTable.setColumnCount(5)
        ...
        self.paymentTable.horizontalHeader().setDefaultSectionSize(140)
...
"")
        ...
        self.print_btn.setGeometry(QtCore.QRect(1105, 605, 140, 30))
...
"}")
        ...
        self.label_5.setGeometry(QtCore.QRect(1110, 610, 140, 30))
...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "Patiend ID"))
        ...
        self.payment_title.setText(_translate("Dialog", "Payment History of Date: "))
        self.return_btn.setText(_translate("Dialog", "Return"))
        self.print_btn.setText(_translate("Dialog", "Print"))
        self.label_5.setText(_translate("Dialog", "Print"))
