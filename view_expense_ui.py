...
# Form implementation generated from reading ui file 'view_expense.ui'
#
...
"")
        ...
        self.expenseTable = QtWidgets.QTableWidget(Dialog)
        self.expenseTable.setGeometry(QtCore.QRect(210, 100, 991, 441))
        self.expenseTable.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.expenseTable.setStyleSheet("background-color: rgba(255, 255, 255,.9);\n"
"\n"
"font:  12pt \"Segoe UI \";")
        ...
        self.expenseTable.horizontalHeader().setDefaultSectionSize(140)
        self.expense_title = QtWidgets.QLabel(Dialog)
        self.expense_title.setGeometry(QtCore.QRect(210, 60, 991, 41))
        self.expense_title.setStyleSheet("\n"
"color: rgb(255, 255, 255);\n"
"background-color: rgb(0, 0, 0);\n"
"\n"
"font:  14pt \"Segoe UI \";")
        self.expense_title.setObjectName("expense_title")
...
"")
        ...
        self.label_5.setGeometry(QtCore.QRect(1065, 625, 140, 30))
...
"")
        ...
        self.print_btn.setGeometry(QtCore.QRect(1060, 620, 140, 30))
...
"}")
        ...
        self.expenseTable.raise_()
        self.expense_title.raise_()
        self.label_3.raise_()
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "Expense Date"))
        item = self.expenseTable.horizontalHeaderItem(1)
        item.setText(_translate("Dialog", "Expense Description"))
        item = self.expenseTable.horizontalHeaderItem(2)
        item.setText(_translate("Dialog", "Expense Remarks"))
        item = self.expenseTable.horizontalHeaderItem(3)
        item.setText(_translate("Dialog", "Expense Amount"))
        self.expense_title.setText(_translate("Dialog", "Expense History of Date: "))
